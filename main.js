...
module.exports.loop = function () {
    ...
    if(upgraders.length < 8) {
        var newName = Game.spawns.Home.createCreep([WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE], undefined, {role: 'upgrader'});
    ...
    if(miners.length < 3) {
        var newName = Game.spawns.Home.createCreep([WORK,CARRY,MOVE], undefined, {role: 'miner'});
        console.log('Spawning new miner: ' + newName);
    }

    if(miners2.length < 3) {
        var newName = Game.spawns.Home.createCreep([WORK,CARRY,MOVE], undefined, {role: 'miner2'});
